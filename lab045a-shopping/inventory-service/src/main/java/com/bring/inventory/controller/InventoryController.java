...
public class InventoryController {
    ...
    // curl -X GET "http://localhost:<dynamicport>>/api/inventory/iphone12"
    ...
    //  curl -X GET "http://localhost:<dynamic-port>/api/inventory/items"
...
PS C:\ws>
    ...
    // curl "http://localhost:<dynamic-port>/api/inventory/list?skuCode=iphone12&skuCode=iphone15"
