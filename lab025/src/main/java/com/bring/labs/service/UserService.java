    ...
    public String verify(AuthUser authUser) {
        ...
        Authentication authentication=
                authenticationManager
                        .authenticate(new UsernamePasswordAuthenticationToken(authUser.getName(), authUser.getPassword()));
        ...
        if (authentication.isAuthenticated()){
            ...
            System.out.println("User is not authenticated. However, this is never reached and automatically 401 is raised by spring security");
            return "failure";
        }
